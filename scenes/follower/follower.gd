...
@export var hold_player_distance := 3.0

@export var weight_cohesion := 0.5
@export var weight_separation := 1.5
@export var weight_alignment := 0.3
@export var weight_target := 1.0
